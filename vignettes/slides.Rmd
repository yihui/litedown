...
The script
[`snap.js`](https://github.com/yihui/litedown/blob/main/inst/resources/snap.js)
...
The full CSS is
[`snap.css`](https://github.com/yihui/litedown/blob/main/inst/resources/snap.css),
...
``` html
<script src="https://cdn.jsdelivr.net/gh/yihui/litedown@VERSION/inst/resources/snap.min.js" defer></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/combine/gh/yihui/litedown@VERSION/inst/resources/default.min.css,gh/yihui/litedown@VERSION/inst/resources/snap.min.css">
```

Remember to substitute `VERSION` with [an appropriate
version](https://github.com/yihui/litedown/tags) (e.g., `1.11`). You can omit
