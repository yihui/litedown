...
[`yihui/lite.js` repository](https://github.com/yihui/lite.js). Similarly,
...
is a quick example of using the DataTables library to create interactive tables:
