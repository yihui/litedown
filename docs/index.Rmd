...
choose the latter (especially Quarto). Some **litedown** features may be ported
into **knitr** in the future.
...
can be enabled by adding CSS/JS assets (see @chp:assets). You can freely choose
