...
#### `fill`: code interpolation and inline chunk references {#sec:option-fill}
...
code differently according to different scenarios.
...
The above example also showed the possibility of passing R data to a JavaScript
code chunk.
